...
const title = "About — Claire Tabouret";
const description =
  "Biography and practice of the painter Claire Tabouret: portraiture, memory, collective identity, and exhibitions in institutions worldwide.";
...
const BLOCKS = [
  {
    heading: "Practice",
    body: "Claire Tabouret is a French artist based in Los Angeles. Working primarily in painting, she builds large-scale figures from washes of acrylic laid over saturated grounds, letting colour bleed at the edges so that each portrait holds both presence and disappearance.",
  },
  {
    heading: "Subject",
