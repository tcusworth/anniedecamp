...
export const Route = createFileRoute("/where-to-see")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://anniedecampart.com/__l5e/assets-v1/9cf2115a-7b10-4c31-9625-3090f2303ed5/event-brochure-annie-decamp-art-show.jpeg" },
      { name: "twitter:image", content: "https://anniedecampart.com/__l5e/assets-v1/9cf2115a-7b10-4c31-9625-3090f2303ed5/event-brochure-annie-decamp-art-show.jpeg" },
          ...
          <ul className="ct-where-list">
            {EVENTS.map((it, i) => (
              <li key={it.show} className="ct-where-row" style={{ ["--i" as string]: String(i) }}>
                ...
                {it.rsvp ? (
                  <a className="ct-where-rsvp" href={it.rsvp}>
                    RSVP →
                  </a>
                ) : null}
              </li>
