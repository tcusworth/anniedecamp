...
export const Route = createFileRoute("/studio")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://anniedecampart.com/__l5e/assets-v1/928f6dbe-b1fe-4b9f-a588-a6ee1b8b7802/studio-corner.jpeg" },
      { name: "twitter:image", content: "https://anniedecampart.com/__l5e/assets-v1/928f6dbe-b1fe-4b9f-a588-a6ee1b8b7802/studio-corner.jpeg" },
